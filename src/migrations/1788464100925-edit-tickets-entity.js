 ...
 */
module.exports = class EditTicketsEntity1788464100925 {
    name = 'EditTicketsEntity1788464100925'

    /**
     * @param {QueryRunner} queryRunner
     */
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE "tickets" DROP COLUMN "resolved_at"`);
        await queryRunner.query(`ALTER TYPE "public"."statuses_name_enum" RENAME TO "statuses_name_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."statuses_name_enum" AS ENUM('Abierto', 'En_proceso', 'Cerrado')`);
    ...
    async down(queryRunner) {
        await queryRunner.query(`CREATE TYPE "public"."statuses_name_enum_old" AS ENUM('Abierto', 'En_proceso', 'Cerrado', 'Reabierto')`);
        ...
        await queryRunner.query(`ALTER TABLE "tickets" ADD "resolved_at" TIMESTAMP`);
    }
}
